...
base_path_to_gtc_folder="/local/tsaid/trabajo/gtc19/"
...
csv_manifest_file="/local/tsaid/trabajo/GSAMD-24v2-0_20024620_A1.csv"
...
for gtc_dir in $base_path_to_gtc_folder/*/; do
  ...
  vcf_folder="${output_dir}vcf19_csv/${output_gtc}_vcf"  # Define output VCF folder based on GTC folder
...
#for vcf_folder in `ls /home/tsaid/trabajo/vcf | head -1`; do
 #   copy $vcf_folder  
#done
